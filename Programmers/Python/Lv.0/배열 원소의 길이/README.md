  ...
  <h1><a href="https://school.programmers.co.kr/learn/courses/30/lessons/120854">배열 원소의 길이</a></h1><p>문자열 배열 <code>strlist</code>가 매개변수로 주어집니다. <code>strlist</code> 각 원소의 길이를 담은 배열을 return하도록 solution 함수를 완성해주세요.</p>
