  ...
  <h1><a href="https://school.programmers.co.kr/learn/courses/30/lessons/120851">숨어있는 숫자의 덧셈 (1)</a></h1><p>문자열 <code>my_string</code>이 매개변수로 주어집니다. <code>my_string</code>안의 모든 자연수들의 합을 return하도록 solution 함수를 완성해주세요.</p>
