  ...
  <h1><a href="https://school.programmers.co.kr/learn/courses/30/lessons/181869">공백으로 구분하기 1</a></h1><p>단어가 공백 한 개로 구분되어 있는 문자열 <code>my_string</code>이 매개변수로 주어질 때, <code>my_string</code>에 나온 단어를 앞에서부터 순서대로 담은 문자열 배열을 return 하는 solution 함수를 작성해 주세요.</p>
