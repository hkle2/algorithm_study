  ...
  <h1><a href="https://school.programmers.co.kr/learn/courses/30/lessons/181831">특별한 이차원 배열 2</a></h1><p>n × n 크기의 이차원 배열 <code>arr</code>이 매개변수로 주어질 때, <code>arr</code>이 다음을 만족하면 1을 아니라면 0을 return 하는 solution 함수를 작성해 주세요.</p>
