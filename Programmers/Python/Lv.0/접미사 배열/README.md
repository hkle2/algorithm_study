  ...
  <h1><a href="https://school.programmers.co.kr/learn/courses/30/lessons/181909">접미사 배열</a></h1><p>어떤 문자열에 대해서 접미사는 특정 인덱스부터 시작하는 문자열을 의미합니다. 예를 들어, "banana"의 모든 접미사는 "banana", "anana", "nana", "ana", "na", "a"입니다.<br>
