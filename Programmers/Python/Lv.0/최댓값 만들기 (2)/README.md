  ...
  <h1><a href="https://school.programmers.co.kr/learn/courses/30/lessons/120862">최댓값 만들기 (2)</a></h1><p>정수 배열 <code>numbers</code>가 매개변수로 주어집니다. <code>numbers</code>의 원소 중 두 개를 곱해 만들 수 있는 최댓값을 return하도록 solution 함수를 완성해주세요.</p>
